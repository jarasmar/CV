...
--- | --- | --- | --- | ---
Mix Tape | First time using React calling Rails for the backend and Spotify API. Combines selected users top tracks to generate a playlist that you can listen from the browser | Rails, React, Postgres, CSS | Rspec, Capybara | <a href="https://mix-tape-makers.herokuapp.com/signin"><img alt="heroku" src="./images/Heroku_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/mix-tape"><img alt="code" src="./images/Code_Logo.png" height="42" width="42"> </a>
Corona Run Game | Run and jump game built for a 2.5 days hackathon | javascript, p5.js, CSS |  | <a href="https://jarasmar.github.io/hfh_corona_game/"><img alt="github-page" src="./images/Github_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/hfh_corona_game"><img alt="code" src="./images/Code_Logo.png" height="42" width="42"> </a>
Acebook | First time using Rails, building a clone of Facebook | Rails, Postgres, Devise, Bootstrap | Rspec, Capybara | <a href="https://the-undefined-method.herokuapp.com/users/sign_in"><img alt="heroku" src="./images/Heroku_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/acebook-theUndefinedMethod"><img alt="code" src="./images/Code_Logo.png" height="42" width="42"> </a>
MakersBnB | Clone of AirBnb | Ruby, Sinatra, Postgres, CSS | Rspec, Capybara | <a href="https://github.com/jarasmar/MakersBnB"><img alt="code" src="./images/Code_Logo.png" height="42" width="42"> </a>
