...
--- | --- | --- | --- | ---
Second Life | (Work in Progress) An app based on Google Maps API where users can mark the exact location of any kind of goods left on the street for other people to collect | Rails, javascript, Google Maps API, Bootstrap | Rspec | <a href="https://second-life-app.herokuapp.com/"><img alt="heroku" src="./images/Heroku_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/Second_Life"><img alt="code" src="./images/Code-Logo.png" height="42" width="42"> </a>
