...
------- | ----------- | ---------- | ------- | -----
**[Second_Life]** | (Work in Progress) An app based on Google Maps API where users can mark the exact location of any kind of goods left on the street for other people to collect | Rails, javascript, Google Maps API, Bootstrap | Rspec | <a href="https://second-life-app.herokuapp.com/"><img alt="heroku" src="./images/Heroku_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/Second_Life"><img alt="code" src="./images/Code-Logo.png" height="42" width="42"> </a>
Corona Run Game | Run and jump game built for a 2.5 days hackathon | javascript, p5.js, CSS |  | <a href="https://jarasmar.github.io/hfh_corona_game/"><img alt="github-page" src="./images/Github_Logo.png" height="42" width="42"> </a><a href="https://github.com/jarasmar/hfh_corona_game"><img alt="code" src="./images/Code-Logo.png" height="42" width="42"> </a>
